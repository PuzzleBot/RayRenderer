...
void printVector(Vector3D vector){
    printf(" Vector: Pos %.2f %.2f %.2f, Dir %.2f %.2f %.2f\n", vector.position.x, vector.position.y, vector.position.z, vector.direction.x, vector.direction.y, vector.direction.z);
}
