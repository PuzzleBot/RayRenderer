...
## Running the program
The program takes the name of an input file as the only argument. The program can be run using either of these commands:

./bin/raytracer.o <input file path>

make run FILE=<input file path>
